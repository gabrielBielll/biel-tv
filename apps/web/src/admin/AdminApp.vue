...
<template>
  ...
  <main v-else class="grid-2">
    ...
    <section v-if="god" class="card god-card">
      <h2>⚡ Modo God</h2>
      <p class="dim">O chat com o Diretor chega na fase 10 — por aqui você já pode editar a
        identidade editorial de cada canal (o "roteiro" que o Diretor vai seguir) e replanejar a grade.</p>
      <button class="ghost" @click="replanejar">replanejar grade de todos os canais</button>
